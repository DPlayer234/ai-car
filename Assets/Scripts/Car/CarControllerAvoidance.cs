...
namespace DPlay.AICar.Car
{
    ...
    /// </summary>
    public partial class CarControllerAvoidance : CarController
    {
        ...
        private FSM<CarControllerAvoidance> accelerationStateMachine;
        ...
        /// <summary>
        ///     Called by Unity to initialize the <see cref="CarControllerAvoidance"/>.
        /// </summary>
        ...
        /// <summary>
        ///     Called by Unity to update the <see cref="CarControllerAvoidance"/> every fixed update.
        /// </summary>
        ...
        {
            accelerationStateMachine = new FSM<CarControllerAvoidance>(this);
